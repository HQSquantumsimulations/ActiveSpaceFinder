# How to contribute
We are happy to consider your contribution for inclusion in this project. To contribute open a pull request and we will get back to you.
...
1. Testing: we use pytest for this project. We require that all previous tests pass and that you provide proper tests with your contribution.
2. MyPy: we use type annotations and mypy to check for proper type annotations and usage of types throughout the code.
3. Linting: we use ruff with the configuration in pyproject.toml.
4. Code formatting: we use black with the configuration in pyproject.toml.
